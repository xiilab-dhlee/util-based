...
interface AlertCardProps extends AlertListType {
  isSelected: boolean;
}
...
export function AlertCardComponent({
  ...
  const setSelectedAlert = useSetAtom(alertSelectedAtom);
 ...
 *
 * @param props - Alert 타입의 props
 * @returns 안전성이 보장된 알림 카드 컴포넌트
 */
const AlertCard = (props: AlertCardProps) => {
  return withSafeProps(AlertCardComponent)(props);
};
