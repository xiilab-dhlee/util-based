...
export const updateImageBody = zod
  .object({
...
export const updateImageResponse = zod
  .object({
 ...
 */
export const getPullPushJobs1QueryPageRequestPageSizeMax = 100;
...
export const getPullPushJobs1QueryParams = zod.object({
  pageRequest: zod.object({
    ...
    pageSize: zod
      .number()
      .min(1)
      .max(getPullPushJobs1QueryPageRequestPageSizeMax)
      .describe("페이지 크기"),
    keyword: zod.string().optional().describe("검색 키워드"),
  }),
  filterRequest: zod.object({
