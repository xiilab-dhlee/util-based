...
import { useGetAdminInternalRegistryImage } from "@/domain/internal-registry-image/hooks/use-get-admin-internal-registry-image";
...
import { AdminInternalRegistryImageTagListBody } from "./admin-internal-registry-image-tag-list-body";
import { AdminInternalRegistryImageTagListFilter } from "./admin-internal-registry-image-tag-list-filter";

export function AdminInternalRegistryImageDetailBody() {
  ...
  const { data } = useGetAdminInternalRegistryImage({
    registryName,
    imageId,
  });

  const handleDelete = () => {
    publish(INTERNAL_REGISTRY_IMAGE_EVENTS.sendDeleteAdminRegistryImage, {
      registryName,
      imageId,
    });
  };
  ...
  return (
    <Container>
      ...
      <AdminInternalRegistryImageTagListFilter />
      <AdminInternalRegistryImageTagListBody />
    </Container>
  );
}
