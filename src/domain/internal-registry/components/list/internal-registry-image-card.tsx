...
interface InternalRegistryImageCardProps
  extends InternalRegistryImageListType {}

export function InternalRegistryImageCard({
  id,
  projectId,
  name,
  description,
  pullCnt,
  updatedAt,
}: InternalRegistryImageCardProps) {
  const router = useRouter();

  const handleClick = () => {
    router.push(`/admin/internal-registry/${projectId}/image/${id}`);
  };
  return (
    <Card
