...
import { userPrivateRegistrySortAtom } from "@/domain/registry/state/registry.atom";
...
interface UserPrivateRegistryBodyProps {
  data: PrivateImageUsageResponse[];
  isLoading: boolean;
  isError: boolean;
}

export function UserPrivateRegistryBody({
  data,
  isLoading,
  isError,
}: UserPrivateRegistryBodyProps) {
