...
import type { VulnerabilityScanRequest } from "@/api/generated/astragoBackendAPIDocumentation.schemas";
...
export const useScanRegistryTagByMode = (
  mode: RegistryMode,
): UseMutationResult<unknown, unknown, { data: VulnerabilityScanRequest }> => {
