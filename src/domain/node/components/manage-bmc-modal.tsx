...
import { useCreateBmc } from "@/domain/node/hooks/use-create-bmc";
import { useUpdateBmc } from "@/domain/node/hooks/use-update-bmc";
import { openManageBmcModalAtom } from "@/domain/node/state/node.atom";
import type {
  CreateBmcPayload,
  UpdateBmcPayload,
