...
interface InternalRegistryImageTagCardProps
  extends InternalRegistryImageTagListType {}
/**
 * 내부 레지스트리 이미지 태그 카드 컴포넌트
 *
 * 태그 명, 취약점 정보를 컴팩트하게 표시하는 카드
 */
export function InternalRegistryImageTagCard({
  tag,
  imageSize,
  critical,
  high,
  ...
  creatorName,
  lastCheckedAt,
}: InternalRegistryImageTagCardProps) {
