...
import { internalregistryImageTagCheckedListAtom } from "@/domain/internal-registry-image/state/internal-registry-image.atom";
import { ColumnAlignCenterWrap } from "@/styles/layers/column-layer.styled";

interface InternalRegistryImageTagItemCheckProps {
  /** 태그 데이터 */
 ...
 */
export function InternalRegistryImageTagItemCheck({
  tag,
}: InternalRegistryImageTagItemCheckProps) {
