        ...
        const customChartOptions = {
          ...
          dataLabels: {
            ...
            formatter: (
              ...
              const seriesData = seriesIndices[seriesIndex];

              if (!seriesData) return "";

              if (dataPointIndex === seriesData.data.minIndex)
                return `최소: ${val}${unit}`;
              if (dataPointIndex === seriesData.data.maxIndex)
                return `최대: ${val}${unit}`;
