...
import type { GetAdminWorkspaceListSort } from "@/api/generated/astragoBackendAPIDocumentation.schemas";
import {
...
} as const satisfies Record<string, GetAdminWorkspaceListSort>;
