...
import type { GetAdminAllWorkspacesSort } from "@/api/generated/astragoBackendAPIDocumentation.schemas";
import {
...
} as const satisfies Record<string, GetAdminAllWorkspacesSort>;
