...
import { openDeleteAdminPrivateRegistryImageModalAtom } from "@/domain/private-registry-image/state/private-registry-image.atom";
...
export function DeleteAdminPrivateRegistryImageModal() {
  ...
  const { open, onOpen, onClose } = useGlobalModal(
    openDeleteAdminPrivateRegistryImageModalAtom,
  );
