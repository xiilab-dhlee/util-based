...
interface PrivateRegistryTypeSortProps {
  disabled?: boolean;
}
 ...
 */
export function PrivateRegistryTypeSort({
  disabled,
}: PrivateRegistryTypeSortProps) {
  ...
  return (
    <div data-testid={PRIVATE_REGISTRY_SELECTOR.FILTER_TYPE}>
      <Dropdown
