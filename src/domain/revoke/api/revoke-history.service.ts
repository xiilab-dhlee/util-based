...
export class RevokeHistoryService extends AxiosService {
  ...
  /** 리소스 회수 기준 수정 */
  public updateCriteria(payload: RevokeCriteriaRequestPayload[]) {
    return this.getAxios().put<void>(`${this.CRITERIA_URL}/criteria`, payload);
  }
}
